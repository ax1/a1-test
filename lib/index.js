...
module.exports = { testHtmlFolder, testHtmlUrl }

//chromePath: '/usr/lib/chromium-browser/chromium-browser'

async function testHtmlFolder(folderPath, chromePath) {
  try {
...
async function testHtmlUrl(url, chromePath, depth) {
  try {
...
//testHtmlFolder('/home/ubuntu/SOFTWARE/IRIDIUMJS/x/test/html', '/usr/lib/chromium-browser/chromium-browser')
